...
func init() {
	...
	typeregistry["GameMessage_RestoreNotification"] = reflect.TypeOf(GameMessage_RestoreNotification{})
	...
	typeregistry["RestoreNotification"] = reflect.TypeOf(GameMessage_RestoreNotification{})
